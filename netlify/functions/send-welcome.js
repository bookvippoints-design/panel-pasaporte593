...
<body style="margin:0;padding:0;background:#f3f4f6;font-family:Inter,Arial,sans-serif;">
  <table width="100%" cellpadding="0" cellspacing="0" style="background:#f3f4f6;padding:40px 20px;">
    <tr><td align="center">
      <table width="100%" style="max-width:560px;background:#ffffff;border-radius:16px;overflow:hidden;box-shadow:0 2px 12px rgba(0,0,0,0.08);">
        ...
        <tr>
          <td style="background:#1A3F7A;padding:32px;text-align:center;">
            <p style="margin:0;font-size:26px;font-weight:800;color:#ffffff;letter-spacing:-0.5px;">
              Pasaporte<span style="color:#F97316;">593</span>
            </p>
        ...
        <tr>
          <td style="padding:36px 32px;">
            <p style="margin:0 0 8px;font-size:20px;font-weight:700;color:#1A3F7A;">
              ¡Bienvenido a Pasaporte593, ${responsible}! 👋
            </p>
              ...
              <tr>
                <td>
                  ...
                  <p style="margin:0 0 8px;font-size:13px;color:#374151;">
                    🔗 <strong>Panel:</strong> <a href="https://panel-pasaporte593.netlify.app" style="color:#1A3F7A;">panel-pasaporte593.netlify.app</a>
                  </p>
                  <p style="margin:0 0 8px;font-size:13px;color:#374151;">
                    📧 <strong>Usuario:</strong> ${email}
                  </p>
                  <p style="margin:0;font-size:13px;color:#374151;">
                    🔑 <strong>Contraseña temporal:</strong> <span style="font-family:monospace;background:#fff;padding:2px 8px;border-radius:6px;color:#F97316;font-weight:700;">${password}</span>
                  </p>
                </td>
              </tr>
            </table>
            ...
            <p style="margin:0 0 8px;font-size:13px;color:#6b7280;">
              Te recomendamos cambiar tu contraseña la primera vez que ingreses al panel.
            </p>

            <!-- Qué puedes hacer -->
            <p style="margin:20px 0 12px;font-size:14px;font-weight:700;color:#1A3F7A;">¿Qué puedes hacer en tu panel?</p>
            ...
            <p style="margin:0 0 20px;font-size:13px;color:#374151;">⭐ Crear cuentas BookVipPoints con 100 puntos de regalo para tus clientes</p>

            <!-- CTA -->
            <table width="100%" cellpadding="0" cellspacing="0" style="margin-bottom:24px;">
              <tr>
                <td align="center">
                  <a href="https://panel-pasaporte593.netlify.app" style="display:inline-block;background:#F97316;color:#ffffff;font-weight:700;font-size:14px;padding:14px 32px;border-radius:12px;text-decoration:none;">
                    Ingresar al panel →
                  </a>
                </td>
              </tr>
            ...
            <p style="margin:0;font-size:13px;color:#6b7280;line-height:1.6;">
              ...
              <a href="https://wa.me/593981350463" style="color:#10B981;font-weight:600;">+593 98 135 0463</a>
            </p>
          </td>
        </tr>
        ...
        <tr>
          <td style="background:#f9fafb;padding:20px 32px;border-top:1px solid #e5e7eb;text-align:center;">
            <p style="margin:0;font-size:12px;color:#9ca3af;">
              ...
              <a href="mailto:admin@alfonsohidalgo.com" style="color:#9ca3af;">admin@alfonsohidalgo.com</a> · 
      ...
      <p style="margin:16px 0 0;font-size:11px;color:#9ca3af;">Adjuntamos los términos y condiciones y el manual de uso del panel.</p>
    </td></tr>
  </table>
</body>
</html>
  ...
  const payload = JSON.stringify({
    ...
    attachments: [
      ...(terminosPdf ? [{
        filename: 'Terminos_y_Condiciones_Pasaporte593.pdf',
        content: terminosPdf,
      }] : []),
      ...(manualPdf ? [{
        filename: 'Manual_Panel_Pasaporte593.pdf',
        content: manualPdf,
      }] : []),
    ],
  })
